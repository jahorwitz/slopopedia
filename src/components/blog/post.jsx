...
export const Post = ({ className, title, content, date, author }) => {
  ...
  return (
    <>
      <div className={`${className} w-96 -top-14 relative`}>
        ...
        <Button className="bg-yellow-button text-sm h-8 w-30 text-black text-center items-center border mb-4 py-2 px-2">
          Not Slop
        </Button>
